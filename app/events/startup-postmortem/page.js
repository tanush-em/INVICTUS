...
export default function StartupPostmortem() {
  return (
    <div className="p-4 sm:p-6 max-w-3xl mx-auto overflow-x-hidden">
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center">Startup Postmortem: Why Did It Die?</h1>
      <p className="text-center text-base sm:text-lg md:text-xl text-emerald-400 font-semibold mt-2">🔍🔥 Analyze. Diagnose. Conclude.</p>
      ...
      <div className="mt-4 flex justify-center">
        ...
        <img src="/startup-postmartum.png" alt="Startup Postmortem" className="w-full max-w-[500px] h-auto object-cover rounded-lg shadow-md mx-auto" onError={(e) => { e.target.src = 'https://placehold.co/600x400/334155/94a3b8?text=Startup+Postmortem'; }} />
      </div>
      ...
      <div className="mt-4 sm:mt-6 p-4 sm:p-5 bg-gray-600 rounded-lg shadow-md">
        <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-3">💡 Example Failure Reasons</h2>
        <ul className="list-disc list-inside text-gray-300 text-sm sm:text-base space-y-1">
      ...
      <div className="mt-4 sm:mt-6 p-4 sm:p-5 bg-gray-600 rounded-lg shadow-md">
        <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-3">⏱ Presentation Time</h2>
        <p className="text-gray-300 text-sm sm:text-base">3 Minutes + 1 Minute Q&A</p>
      </div>
      ...
      <p className="mt-6 text-center text-base sm:text-lg text-gray-400 italic">Break down the failure and uncover what went wrong 🔍🚀</p>

      <div className="mt-4 sm:mt-6 p-4 sm:p-5 bg-gray-600 rounded-lg shadow-md">
        <h2 className="text-lg sm:text-xl md:text-2xl font-semibold">Contact Information</h2>
        <div className="mt-2 space-y-1">
          <a href="tel:+917305765519" className="text-gray-300 hover:text-blue-500 block py-2 text-sm sm:text-base">Khamar Fathima — +91 7305765519</a>
