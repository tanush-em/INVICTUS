    ...
    <div className="p-4 sm:p-6 max-w-3xl mx-auto overflow-x-hidden">
      ...
      <div className="mt-6 p-5 bg-gray-600 rounded-lg shadow-md">
        ...
        <div className="mt-2 space-y-1">
          <a href="tel:+916381961971" className="text-gray-300 hover:text-blue-500 block">Nelash U — +91 6381961971</a>
          <a href="tel:+919043351402" className="text-gray-300 hover:text-blue-500 block">Manish R — +91 9043351402</a>
        </div>
      </div>

      <div className="mt-8 flex justify-center">
        <Link href="https://docs.google.com/forms/d/e/1FAIpQLSfoZilKDBwi-qc6aCd5XLx3gjSFt834fazWuXwrQNvCmcxBtg/viewform?usp=sharing&ouid=107016111243850562059" target="_blank">
