...
export default function SportsEvents() {
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <div className='max-w-3xl bg-gray-800 p-4 mt-12 rounded-2xl shadow-2xl border border-gray-700">'>
        ...
        <div className="mt-6">
          <h2 className="text-2xl font-semibold">Rules & Regulations</h2>
          <ul className="list-disc list-inside mt-2 text-lg">
            <li>Each team must have 5 players and a maximum of 2 substitutes.</li>
