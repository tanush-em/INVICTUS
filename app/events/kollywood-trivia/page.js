  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <div className="mt-6 p-5 bg-gray-600 rounded-lg shadow-md">
        ...
        <p><strong>Entry Fee:</strong> ₹ 50 per member</p>
      ...
      <div className="mt-8 flex justify-center">
        <Link href="https://docs.google.com/forms/d/e/1FAIpQLScFnZTJxnropiPc-qWQegyaWAqV4ewTL8PP9vckRUSqvZH7JA/viewform" target="_blank">
