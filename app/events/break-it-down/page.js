...
export default function BreakItDown() {
  return (
    <div className="p-4 sm:p-6 max-w-3xl mx-auto overflow-x-hidden">
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center">Break it Down</h1>
      <p className="text-center text-base sm:text-lg md:text-xl text-emerald-400 font-semibold mt-2">😂🔥 Simplify. Entertain. Explain.</p>
      ...
      <div className="mt-4 flex justify-center">
        <Image src="/break-it-down.png" alt="Break it Down" width={500} height={300} className="w-full max-w-[500px] h-auto rounded-lg shadow-md" />
      </div>
      ...
      <div className="mt-4 sm:mt-6 p-4 sm:p-5 bg-gray-600 rounded-lg shadow-md">
        ...
        <p className="text-gray-300 text-sm sm:text-base">2 Minutes per team</p>
      </div>
      ...
      <p className="mt-6 text-center text-base sm:text-lg text-gray-400 italic">Make tech so simple that even grandma enjoys it 😄🚀</p>

      <div className="mt-4 sm:mt-6 p-4 sm:p-5 bg-gray-600 rounded-lg shadow-md">
        <h2 className="text-lg sm:text-xl md:text-2xl font-semibold">Contact Information</h2>
        <div className="mt-2 space-y-1">
          <a href="tel:+917305278740" className="text-gray-300 hover:text-blue-500 block py-2 text-sm sm:text-base">Harritha — +91 7305278740</a>
      ...
      <div className="mt-8 flex justify-center px-4">
        <Link href="https://docs.google.com/forms/d/e/1FAIpQLSfwSH8InR6CmFNeKia5kJ3-RLOjupvPA7tDpPbPePeDuG0RqA/viewform?usp=publish-editor" target="_blank" className="w-full sm:w-auto">
