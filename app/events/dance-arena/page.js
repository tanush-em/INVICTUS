  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <div className="mt-6 p-5 bg-gray-600 rounded-lg shadow-md">
        ...
        <p><strong>Entry Fee:</strong> ₹ 75</p>
      ...
      <div className="mt-8 flex justify-center">
        <Link href="https://docs.google.com/forms/d/e/1FAIpQLSf2TofZF1QycvVwJo3V6OeiCLfgB8t8nOBJ0tDzzBFFGhbHhA/viewform" target="_blank">
