...
export default function DebugDash() {
  return (
    <div className="p-4 sm:p-6 max-w-3xl mx-auto overflow-x-hidden">
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center">Debug Dash: Code Under Pressure</h1>
      <p className="text-center text-base sm:text-lg md:text-xl text-emerald-400 font-semibold mt-2">⚡🔥 Detect. Fix. Win.</p>
      ...
      <div className="mt-4 flex justify-center">
        <Image src="/debug-dash.png" alt="Debug Dash" width={500} height={300} className="w-full max-w-[500px] h-auto rounded-lg shadow-md" />
      </div>
      ...
      <div className="mt-4 sm:mt-6 p-4 sm:p-5 bg-gray-600 rounded-lg shadow-md">
        <h2 className="text-lg sm:text-xl md:text-2xl font-semibold mb-3">⏳ Twist</h2>
        <ul className="list-disc list-inside text-gray-300 text-sm sm:text-base space-y-1">
      ...
      <p className="mt-6 text-center text-base sm:text-lg text-gray-400 italic">Stay sharp, debug fast, and beat the clock 🚀</p>

      <div className="mt-4 sm:mt-6 p-4 sm:p-5 bg-gray-600 rounded-lg shadow-md">
        <h2 className="text-lg sm:text-xl md:text-2xl font-semibold">Contact Information</h2>
        <div className="mt-2 space-y-1">
          <a href="tel:+918610301544" className="text-gray-300 hover:text-blue-500 block py-2 text-sm sm:text-base">Soujhenya — +91 8610301544</a>
      ...
      <div className="mt-8 flex justify-center px-4">
        <Link href="https://docs.google.com/forms/d/e/1FAIpQLSdcdimKe8ASC2MPUeO_yXyQtVofY6BVKntIEl0la_TBdfelzA/viewform?usp=dialog" target="_blank" className="w-full sm:w-auto">
